                ...
                className='flex-1'>
                    ...
                    className='grid grid-cols-1 sm:grid-cols-1 gap-6 max-w-2xl'>
                        {infoList.map(({ icon, iconDark, title, description }, index) => (
                            ...
                            className='border-[0.5px] border-gray-400 rounded-xl  cursor-pointer hover:bg-light-hover hover:-translate-y-1 duration-500 hover:shadow-gray dark:border-white dark:hover:shadow-white/30 dark:hover:bg-dark-hover/50 flex items-start sm:items-center gap-4 px-4 py-3 sm:min-h-20' key={index}>
