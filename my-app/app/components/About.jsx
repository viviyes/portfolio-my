      ...
      >
        ...
        >
          <p className="mb-10 max-w-2xl font-ovo">
            I develop full-stack applications that combine solid back-end logic
            with responsive front-end design. I integrate AI capabilities
            through model APIs, fine-tuning, and A/B testing to optimise
            performance in real scenarios. From databases and APIs to cloud
            deployment, my workflow is supported by automated CI/CD pipelines
            using Docker and GitHub Actions, ensuring reliable delivery. I bring
            hands-on project experience and real industry development
            background.
          </p>
          <motion.ul
            initial={{ opacity: 0 }}
              ...
              >
                <div className="flex items-center gap-3 2xl:gap-4">
                  <Image
                    ...
                    className="w-7"
                  />
                  <h3 className="m-0 font-semibold text-gray-700 dark:text-white whitespace-nowrap shrink-0">
                    {title}
                  </h3>
                </div>
